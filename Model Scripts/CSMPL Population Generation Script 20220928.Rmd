---
title: "CSMPI Population Generation Script 20220928"
...
for(r in 1:ngroups){
  ...
  for(p in 1:nrow(fchoice)){
    ...
    if(chosenfemale==p){
      ...
      avGpairs<-rbind(avGpairs,cbind(femalesg[p,],malesg[chosenmale,]))
    }
  ...
  for(p in 1:nrow(fchoice)){
    ...
    if(chosenfemale==p){
      #Pair the male and female together
      sexGpairs<-rbind(sexGpairs,cbind(femalesg[p,],malesg[chosenmale,]))
    }
